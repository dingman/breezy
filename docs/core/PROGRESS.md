...
**KILL clock:** D0=09-05, counter 0 (09-05 uncovered; 09-06 uncovered (recorder)); at 4 covered/day with 0 fills the 15th lands ~09-09/09-10 and zero-fill/retired-AMBIGUOUS takes are not trials. GL-2, GL-3, GL-5 (backoff), GL-9 and GL-12 landed; GL-1 and GL-4 are under ruling; GL-12/GL-5 reach the recorder at its next restart (09:00Z rotate) — coverage from 09-08 is the first evidence.
