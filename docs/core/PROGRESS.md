...
- **[MED] Daily relaunch supervisor LIVE** (`breezy-trade-supervisor`, `cbcb1ab..e335b80`, pid own-SID since 09-05 00:25Z; peer-reviewed, plan Rev 3). Logging fix `2e033b8`, restarted 09-05 ~00:50Z with a file log. Open: first unattended cycle 09-05 16:40/16:50/17:05 UTC must be verified (`~/.local/share/breezy/logs/breezy-trade-supervisor.log`; coordinator Monitor armed). Fallback: session cron 16:20 UTC relaunches by hand (L-26).
